  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-3xl font-bold text-gray-800 dark:text-slate-100 font-semibold">Recommendations</h2>
        <button
          onClick={() => {
            setEditingRec(null);
            setFormData({ type: 'to watch', title: '', description: '', url: '', status: 'pending' });
              ...
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <h3 className="text-xl font-semibold text-gray-800 dark:text-slate-100">{rec.title}</h3>
                  ...
                  {rec.description && (
                    <p className="text-gray-600 dark:text-slate-300 mb-3">{rec.description}</p>
                  )}
                  {rec.url && (
                    <a
                      href={rec.url}
                ...
                <div className="flex flex-col space-y-2 ml-4">
                  ...
                  <button
                    ...
                    className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 px-3 py-1 text-sm transition-colors duration-200"
                  >
                    Edit
                  </button>
                  <button
                    onClick={() => handleDelete(rec.id)}
                    className="text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-300 px-3 py-1 text-sm transition-colors duration-200"
                  >
                    Delete
                  </button>
                </div>
